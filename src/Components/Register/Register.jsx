...
const Register = () => {
  ...
  <input type="text" name="name" className="grow p-2" placeholder="Your Name" required />
</label>
            <label className="input input-bordered flex items-center gap-2">
...
<label>
<input type="submit" className="p-2 rounded-lg w-full bg-[#214D5B] text-[#C8E264] mt-8" value="Register"></input>
</label>
            </form>
            {
